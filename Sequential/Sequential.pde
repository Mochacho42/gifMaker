...
void setup() {
  ...
  images[0]  = loadImage("pika.png");
  images[1]  = loadImage("pika.png"); 
  images[1].filter(INVERT);
  images[2]  = loadImage("pika.png");
  images[2].filter(THRESHOLD, 0.5);
  images[3]  = loadImage("pika.png"); 
  images[3].filter(POSTERIZE, 5); 
  images[4]  = loadImage("pika.png");
  images[4].filter(DILATE); 
  images[5]  = loadImage("pika.png");
  images[5].filter(INVERT);
  images[6]  = loadImage("pika.png");
  images[6].filter(GRAY);
  images[7]  = loadImage("pika.png"); 
  images[7].filter(THRESHOLD, 0.5);
  images[7].filter(INVERT);
  images[8]  = loadImage("pika.png");
